...
public class IOStreamEx {
	...
	public static void main(String[] args) {
		 ...
		 * 	-출력 : OutputStream : fileInputStream, PrintStream, BufferedOutputSteam ...
		 * - 문자 스트림
		 ...
		 * - 기반스트림EX : fileInputStream, fileInputStream, FileReader, FileWriter ...
		 * - 보조스트릠EX : InputStreamReader, BufferedReader, BufferedWriter, BufferedOutputSteam
		 * 
		 * */
		// 표준 출력(모니터) 스트림
		System.out.println();
